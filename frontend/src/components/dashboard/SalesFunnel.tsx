...
export default function SalesFunnel({ data }: SalesFunnelProps) {
  if (!data || !data.statusFunnel) {
    return (
      <div className="bg-white rounded-lg shadow-sm border p-4">
        <h3 className="font-semibold text-gray-900 mb-4 text-sm">Sales Funnel</h3>
        <p className="text-sm text-gray-500 text-center py-8">No funnel data available</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 p-4">
      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4 text-sm">Sales Funnel</h3>
        ...
        {funnelStages.map((stage, index) => (
          <div key={index} className="relative">
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-sm font-bold text-gray-900 dark:text-gray-100">{stage.count}</span>
            </div>
      ...
      <div className="mt-4 pt-4 border-t dark:border-gray-700 grid grid-cols-2 gap-3">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Contact Rate</p>
        </div>
        <div className="text-center">
